...
export function serveStatic(app: Express) {
  // In production, the client files are in dist/ (same level as server bundle)
  const distPath = path.resolve(__dirname, "..", "dist");
  
  // Fallback to current directory if dist doesn't exist (for esbuild output structure)
